...
imagePaths = os.listdir("D:\\5th Semester\\DBMS2\\ibtd\\image")
maskPaths = os.listdir("D:\\5th Semester\\DBMS2\\ibtd\\mask")
...
for i in range(len(imagePaths)):
    im = Image.open(join("D:\\5th Semester\\DBMS2\\ibtd\\image",imagePaths[i]))
    ms = Image.open(join("D:\\5th Semester\\DBMS2\\ibtd\\mask",maskPaths[i]))
    im = im.convert('RGB')
    ms = ms.convert('RGB')
